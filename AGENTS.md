...
- **Docstrings**: Use google styled docstrings with `Args:` and `Returns`
- **No em-dashes**: Strictly avoid using em-dashes in code
- **No funky comments**: Avoid writing funky comments e.g., writing `===` inside
a comment, `---` is to be avoided, avoid line separator comments e.g. `=========`
